...
// import 'Pages/Hosted_Tour_nearme.dart';
...
//       ),
//       initialRoute: '/signup', // Replace home with initialRoute
//       routes: {
...
import 'package:get_storage/get_storage.dart';
import 'Pages/Hosted_Tour_nearme.dart';
import 'CreateTrip/CreateTripForm.dart'; // Ensure this is the correct import for CreateTripScreen
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/HomePage': (context) => MainPage(),
        '/ChooseTours': (context) => ChooseTours(),
        '/CreateTripScreen': (context) => CreateTripScreen(), // Ensure this is correct
      },
    );
  }
}
...
class _MainPageState extends State<MainPage> {
  ...
  final List<Widget> _pages = [
    ...
    ChatPage(),
    Match(),
    CreateTrip(), // Ensure this matches the route
  ];
